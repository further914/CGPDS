function [gKern, gVarmeans, gVarcovars, gInd] = linardVardistPsi1Gradient(linardKern, vardist, Z, covGrad)

% LINARDVARDISTPSI1GRADIENT description.
%
%	Description:
%	[gKern, gVarmeans, gVarcovars, gInd] = linardVardistPsi1Gradient(linardKern, vardist, Z, covGrad)
%% 	linardVardistPsi1Gradient.m SVN version 1582
% 	last update 2011-09-07T17:23:12.311180Z
