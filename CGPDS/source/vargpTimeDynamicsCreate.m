...
% 	vargpTimeDynamicsCreate.m SVN version 1748
...
samd = varargin{5};
samr = varargin{6};
initParams = vargpTimeDynamicsExtractParam(model,samd,samr); % var parameters and Kt kernel parameters
% This forces kernel computation.
model = vargpTimeDynamicsExpandParam(model, initParams,samd,samr);
