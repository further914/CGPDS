function g = vargplvmGradient(params, model ,stepSize, samd, samr)

% VARGPLVMGRADIENT Variational GP-LVM gradient wrapper.
%
%	Description:
%
%	G = VARGPLVMGRADIENT(PARAMS, MODEL) is a wrapper function for the
%	gradient of the negative log likelihood of an variatioanl GP-LVM
...
%
%	See also
%	VARGPLVMLOGLIKEGRADIENTS, VARGPLVMEXPANDPARAM
