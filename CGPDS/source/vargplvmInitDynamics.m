function model = vargplvmInitDynamics(model,optionsDyn,samd,samr)

% VARGPLVMINITDYNAMICS Initialize the dynamics of a var-GPLVM model.
%
%	Description:
%
%	VARGPLVMINITDYNAMICS(OPTIONSDYN)
%	 Arguments:
%	  OPTIONSDYN - the VARGPLVM structure with the options used to
%	   create the vargplvm model..
%	
%	
%
%	See also
%	VARGPLVMOPTIONSDYN, VARGPLVMADDDYNAMICS
...
% model.dynamics.vardist.means = model.dynamics.vardist.means/max(max(model.dynamics.vardist.means));
