function [g, model] = vargplvmSeqDynLogLikeGradient(model, vardistx, y,samd,samr)
...
% 
% gPsi0_full = model.beta*(tempMatrix.P1TP1_v*model.Psi0'*model.partm*model.partm');
% gPsi0 = gPsi0_full(:,N+1:N+Nstar);
% gPsi2 = -0.5 * model.beta * lendPresent;
% gPsi4 = (model.beta/2) * tempMatrix.T1_v;
% 
% gPsi0 = dpre/lendPresent * gPsi0;
% gPsi2 = dpre/lendPresent * gPsi2;
% gPsi4 = dpre/lendPresent * gPsi4;
